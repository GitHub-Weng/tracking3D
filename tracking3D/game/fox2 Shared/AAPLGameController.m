...
- (AAPLButtonOverlay*)getAAPLButtonOverlay:(NSString*)buttonName_JumpOrAttack{
    return [_overlay getAAPLButtonOverlay:buttonName_JumpOrAttack];
}
...
//Here is the jump and attack action controll
